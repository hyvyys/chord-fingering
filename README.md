...
## findChord(symbol) ⇒ <code>object</code>
...
## findFingerings(notes, [optionalNotes], [bass], [tuning]) ⇒ <code>object</code>
...
## findGuitarChord(symbol, [tuning]) ⇒ <code>object</code>
...
## detectBarre(positions, [stringCount]) ⇒ <code>object</code>
...
## findPositions(notes, [tuning]) ⇒ <code>Array.&lt;Object&gt;</code>
Return all positions within the first octave on the fretboard where a set of notes can be played in a given tuning.
...
## findFret(note, stringNote) ⇒ <code>Number</code>
...
## parseTuning(arg) ⇒ <code>Array.&lt;string&gt;</code>
